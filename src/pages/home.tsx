...
export default function Home({onSwitchForm}: homeProps) {
  ...
  >
    {Object.values(welcomeText).map((word, wIndex) => (
      ...
      <section className="mt-16 grid gap-8 md:grid-cols-3 max-w-5xl w-full">
        <div className="p-6 bg-white rounded-xl shadow border border-gray-700 hover:shadow-lg transition">
          <h3 className="text-xl font-semibold mb-2">Fast</h3>
          <p className="text-gray-600">
            Built with React and Tailwind, and used neovim as code-editor
          </p>
        </div>
        <div className="p-6 bg-white rounded-xl shadow hover:shadow-lg border border-gray-700 transition">
          <h3 className="text-xl font-semibold mb-2">Cosmos</h3>
          <p className="text-gray-600">
            Custom made by Me with my own hands.
          </p>
        </div>
        <div className="p-6 bg-white rounded-xl shadow hover:shadow-lg border-gray-700 border transition">
